...
class ThemeColors{
  static const Color kBackGroundColor = Color(0xffdee8fc);
  static const Color kDarkShadowColor = Color(0xffabbad2);
  static const Color kLightShadowColor = Colors.white;
